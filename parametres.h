 ...
 * ----------------------------------------------------------------
 * @param dimensions -> int *, tableau d'entiers contenant les dimensions de la grille
 * @param diagonale -> Boolean*, un pointeur vers un booléen informant sur le placement de mots en diagonale
 * @param time -> int *, un pointeur vers l'entier contenant le temps de la partie
 * @return -> void
 */
 ...
 * ----------------------------------------------------------------------------------
 * @param diagonale -> Boolean*, le booléen informant de l'activation de la règle du jeu des mots en diagonale
 * @return -> void
 */
 ...
 * ----------------------------------------------------------------------------------------------------------
 * @param time -> int *, un pointeur vers la variable contenant le temps de jeu désiré par le joueur
 * @return -> void
 */
